$(document).ready(function() {
  ...
  test("extend", function() {
    ...
    equal(_.extend({a:'x'}, {a:'b'}).a, 'b', 'properties in source overwrite destination');
    equal(_.extend({x:'x'}, {a:'b'}).x, 'x', 'properties not in source dont get overwritten');
  ...
  test("defaults", function() {
    ...
    ok(isNaN(options.nan), "NaN isn't overwritten");
